...
const getMp3 = ()=>{
    ...
    parseFile(file, (binaryData)=>{
         ...
         window.resolveLocalFileSystemURL(cordova.file.externalApplicationStorageDirectory+'files/',function(dirEntry){
            console.log('new direntry for file: ',dirEntry);
...
function newWay(){
    ...
    document.getElementById('wrighted').innerHTML = counter;
    document.getElementById('wantTowrite').innerHTML = myfiles.length;
...
document.querySelector('.merge').onclick = newWay;
